...
| [HTEB English](configs/hteb_english.yaml)                    | 19         | 4                  | 3       | Config to run HTEB on its English datasets (as used in the paper).                                                                                                                                            |
| [HTEB Multilingual](configs/hteb_multilingual.yaml)          | 13         | 4                  | 3       | Config to run HTEB on its Multilingual datasets (as used in the paper).                                                                                                                                       |
